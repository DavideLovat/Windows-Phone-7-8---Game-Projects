...
namespace ZoneGame
{
    public static class Reader
    {
        ...
        public static Dictionary<string, string> LoadLanguage(string sceneTag)
        {
            ...
            XDocument languageDoc = new XDocument(LanguageDocPath);

            foreach (XElement scene in languageDoc.Document.Element("Screnes").Elements("Scene"))
            {
        ...
        {
            XDocument languageDoc = new XDocument(HelpReferencesDocPath);

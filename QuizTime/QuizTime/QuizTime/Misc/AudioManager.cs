...
namespace QuizTime
{
    public class AudioManager : GameComponent
    {
        ...
        public static void LoadSounds()
        {
            ...
            LoadSound("success", "success");
            LoadSound("failure", "failure");
            LoadSound("gameOver", "gameOver");
            LoadSound("gameEndSuccess", "gameEndSuccess");
            LoadSound("alarmClock", "alarmClock");
            LoadSound("sideBarMovement", "sideBarMovement");
            LoadSound("sideBarHitPosition", "sideBarHitPosition");
            LoadSound("grillMovement", "grillMovement");
            LoadSound("grillHitPosition", "grillHitPosition");
